...
.email-link .bi-envelope {
    font-size: 16px;
    vertical-align: middle;
}
.email-link:hover .bi-envelope {
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-container">
        ...
        <p><strong>Email:</strong> <?php echo htmlspecialchars($candidateInfo['email']); ?> <a href="https://mail.google.com/mail/?view=cm&fs=1&to=<?php echo urlencode($candidateInfo['email']); ?>&su=<?php echo urlencode($first_interview_data['process']); ?>" target="_blank" class="email-link"> <i class="bi bi-envelope"></i> </a> </p>
        ...
        <div class="btn-group">
          <form method="POST" action="candidate_list.php" style="display:inline;">
          ...
          <a href="<?php echo $calendarUrl; ?>" target="_blank" class="ml-2"> <i class="bi bi-calendar" style="font-size: 1.5rem; color: #4285F4;"></i> </a> </div>
      </div>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><div class="d-flex justify-content-center"><?php echo generateRatingBar($review['rating']); ?></div></td>
              <td class="text-center"><?php if ($review['approved'] === 'Yes'): ?>
            ...
            <tr>
              <td colspan="3"><strong>Observations:</strong> <?php echo htmlspecialchars($review['observations']); ?><br>
                <small><strong>Interviewer Name:</strong> <?php echo htmlspecialchars($review['interviewer_name']); ?>, <strong>Review Date:</strong> <?php echo htmlspecialchars($review['review_date']); ?></small></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
            ...
            <div class="ratings">
              ...
              <div class="rating-section d-flex align-items-center mb-1">
                <div class="rating-bar" style="display: flex; align-items: center;">
                  ...
                  <?php endfor; ?>
                  <small class="ml-2"><?php echo htmlspecialchars($review['reviewer_initials']); ?></small> </div>
              </div>
              <?php endforeach; ?>
            </div>
          </div>
